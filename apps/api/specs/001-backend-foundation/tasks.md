...
- [ ] T178 Commit only SPEC-BE-001 owned files with a clear message after T177 passes; verify unrelated `.agents/plugins/` is not staged and `git show --stat --oneline HEAD` contains no Mobile/Admin change
