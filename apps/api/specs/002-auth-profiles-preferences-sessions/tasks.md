...
- [ ] T141 Commit the verified SPEC-BE-002 change on the existing `codex/backend-spec-be-002` delivery branch with a clear Spec-identifying message after T139-T140 pass; verify the commit contains no unrelated/untracked user files and reference it in `apps/api/specs/002-auth-profiles-preferences-sessions/checklists/definition-of-done.md`
- [ ] T142 Push `codex/backend-spec-be-002` to `https://github.com/abdullah-zordok/MASREFY_Final` without force or merge; record the remote commit reference in `apps/api/specs/002-auth-profiles-preferences-sessions/checklists/definition-of-done.md`
