    ...
    >
      ...
      >
        ...
        <View testID={`home-transaction-text-${transaction.id}`} style={[styles.transactionText, { alignItems: direction === 'rtl' ? 'flex-end' : 'flex-start' }]}>
          <Text numberOfLines={1} style={[styles.transactionTitle, { color: theme.colors.content.primary, textAlign: direction === 'rtl' ? 'right' : 'left', writingDirection: direction }]}>{presentation.title}</Text>
          <Text numberOfLines={1} style={[styles.transactionMeta, { color: theme.colors.content.secondary, textAlign: direction === 'rtl' ? 'right' : 'left', writingDirection: direction }]}>{categoryLabel}</Text>
          {accountName ? (
            <View style={styles.transactionAccount}>
              <View style={[styles.transactionAccountDot, { backgroundColor: theme.colors.content.link }]} />
              <Text numberOfLines={1} style={[styles.transactionAccountText, { color: theme.colors.content.secondary }]}>{accountName}</Text>
            </View>
          ) : null}
        </View>
      </View>
...
const styles = StyleSheet.create({
  ...
  accountCard: { alignItems: 'center', borderRadius: radius.lg, borderWidth: borderWidth.default, gap: spacing.md, justifyContent: 'space-between', minHeight: 54, paddingHorizontal: spacing.md, paddingVertical: spacing.sm, width: '100%', writingDirection: 'ltr' },
  ...
  quickActions: { alignSelf: 'stretch', gap: spacing.sm, writingDirection: 'ltr' },
  ...
  sectionHeading: { alignItems: 'center', justifyContent: 'space-between', writingDirection: 'ltr' },
  ...
  transaction: { alignItems: 'center', borderRadius: radius.group, borderWidth: borderWidth.default, gap: spacing.md, minHeight: 80, overflow: 'hidden', paddingHorizontal: spacing.lg, paddingVertical: spacing.md, writingDirection: 'ltr' },
  ...
  processingInline: { alignItems: 'center', alignSelf: 'stretch', borderRadius: radius.lg, borderWidth: borderWidth.default, gap: spacing.md, padding: spacing.md },
