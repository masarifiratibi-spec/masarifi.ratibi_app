...
The Customer Web Dashboard has been removed from the approved product scope. No web-customer shell, navigation, layout grid, dashboard components, or customer web-specific tokens are defined in this version.

Masarifi is an Arabic-first personal finance platform designed for users in the UAE, Saudi Arabia, and the wider Gulf region.

The design system combines:

- Deep financial trust
- Calm Gulf premium identity
- Warm and human product surfaces
- Arabic-first RTL behavior
- Clear financial hierarchy
- Accessible interaction patterns
- Data-dense operational interfaces
...
- Clear
- Accessible
- Distinctive without becoming ornamental

AI should appear as a helpful financial assistant and operational capability, not as the entire identity of the product.
